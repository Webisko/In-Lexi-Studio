  ...
  return (
    <div className="flex flex-col items-center justify-center text-white relative z-10">
      ...
      >
        ...
        <svg width="120" height="120" viewBox="0 0 100 100" className="stroke-gold fill-transparent stroke-[1.5px] drop-shadow-2xl">
      ...
      <motion.h1 
        ...
        className="text-4xl md:text-6xl font-display text-white mb-4 text-center whitespace-nowrap"
      >
        IN LEXI STUDIO
      </motion.h1>
      ...
      <motion.p 
        ...
        className="text-[10px] md:text-[11px] font-sans tracking-[0.4em] text-gold uppercase"
      >
