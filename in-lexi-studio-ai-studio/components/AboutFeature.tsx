      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="flex flex-col items-center gap-20 md:flex-row">
          ...
          <div className="relative flex h-[600px] w-full items-center justify-center md:w-1/2">
            {/* Background Detail Image 1 */}
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="absolute left-0 top-0 z-0 hidden h-64 w-48 md:block"
            >
              <img
            ...
            >
              <div className="relative aspect-[3/4]">
                ...
                <div className="absolute -bottom-10 -right-10 hidden bg-black p-6 shadow-xl md:block">
                  <h2 className="mb-1 font-display text-2xl text-white md:text-3xl">Moments</h2>
                  <h2 className="font-serif text-2xl italic text-gold md:text-3xl">Preserved</h2>
                </div>
              </div>
            </motion.div>

            {/* Foreground Detail Image 2 */}
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.4 }}
              className="absolute bottom-0 right-10 z-20 hidden h-40 w-40 border-4 border-dark-bg md:block"
            >
              <img
          ...
          <div className="w-full space-y-8 md:w-1/2">
            <div className="mb-8 md:hidden">
              <h2 className="mb-2 font-display text-4xl text-white">Moments Preserved,</h2>
              <h2 className="font-serif text-3xl italic text-gold">Emotions Captured</h2>
            </div>
            ...
            <div className="my-8 grid grid-cols-2 gap-4">
              <img
                src="https://images.unsplash.com/photo-1519225448526-0a0295155609?q=80&w=400&auto=format&fit=crop"
                alt="Emotion 1"
                className="h-24 w-full object-cover opacity-70 transition-opacity hover:opacity-100"
              />
              <img
                src="https://images.unsplash.com/photo-1522673607200-1645062cd495?q=80&w=400&auto=format&fit=crop"
                alt="Emotion 2"
                className="h-24 w-full object-cover opacity-70 transition-opacity hover:opacity-100"
              />
            </div>
